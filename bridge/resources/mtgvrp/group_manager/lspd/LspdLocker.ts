...
Event.OnServerEventTrigger.connect((eventName, args) => {
    ...
    switch (eventName) {
        ...
        case "show_lspd_locker":
        {
            ...
            lspd_menu.AddItem(API.createMenuItem("Equip Standard Equipment",
                "Withdraw standard weapons and armour from the LSPD locker."));
            ...
            lspd_menu.OnItemSelect.connect((sender, selectedItem, index) => {
