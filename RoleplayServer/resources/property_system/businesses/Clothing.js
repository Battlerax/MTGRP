...
API.onServerEventTrigger.connect((eventName, args) => {
    switch (eventName) {
        ...
        case "properties_buyclothes":
            ...
            accessory_menu = API.createMenu("Clothes Shop",  "Accessory Selection" + "     ~g~($" + accessory_price + ")", 0, 0, 6);
            undershirt_menu = API.createMenu("Clothes Shop", "Undershirt Selection" + "    ~g~($" + undershirt_price + ")", 0, 0, 6);
            ...
            characterCreationMenu.AddItem(API.createMenuItem("Pants" + "          ~g~($" + pant_price + ")", "View the available pants"));
            characterCreationMenu.AddItem(API.createMenuItem("Shoes"+ "           ~g~($" + shoe_price + ")", "View the available shoes"));
            characterCreationMenu.AddItem(API.createMenuItem("Accessories"+ "     ~g~($" + accessory_price + ")", "View the available accesories. These may require not having an undershirt or top to see."));
            characterCreationMenu.AddItem(API.createMenuItem("Tops"+ "            ~g~($" + top_price + ")", "View the available tops. Some of these require an undershirt."));
            characterCreationMenu.AddItem(API.createMenuItem("Undershirts"+ "     ~g~($" + undershirt_price + ")", "View the available undershirts. These may require a certain top to look correct."));
            characterCreationMenu.AddItem(API.createMenuItem("Hats"+ "            ~g~($" + hat_price + ")", "View the available hats"));
            characterCreationMenu.AddItem(API.createMenuItem("Glasses"+ "         ~g~($" + glasses_price + ")", "View the available glasses"));
            characterCreationMenu.AddItem(API.createMenuItem("Ear Accessories"+ " ~g~($" + ear_price + ")", "View the available ear accessories"));
	        ...
	        pant_menu.OnMenuClose.connect(function (menu) {
		        characterCreationMenu.Visible = true;
		        API.setPlayerClothes(player, 4, oldpantsIndex, oldpantsVariation);
	        });
	        ...
	        shoe_menu.OnMenuClose.connect(function (menu) {
		        characterCreationMenu.Visible = true;
		        API.setPlayerClothes(player, 6, oldshoeIndex, oldshoeVariation);
	        });
	        ...
	        accessory_menu.OnMenuClose.connect(function (menu) {
		        characterCreationMenu.Visible = true;
		        API.setPlayerClothes(player, 7, oldaccessoryIndex, oldaccessoryVariation);
	        });
	        ...
	        undershirt_menu.OnMenuClose.connect(function (menu) {
		        characterCreationMenu.Visible = true;
		        API.setPlayerClothes(player, 8, oldundershirtIndex, oldundershirtVariation);
	        });
	        ...
	        top_menu.OnMenuClose.connect(function (menu) {
		        characterCreationMenu.Visible = true;
		        API.setPlayerClothes(player, 11, oldtopIndex, oldtopVariation);
	        });
	        ...
	        hat_menu.OnMenuClose.connect(function (menu) {
		        characterCreationMenu.Visible = true;
		        API.setPlayerClothes(player, 20, oldhatIndex, oldhatVariation);
	        });
	        ...
	        glasses_menu.OnMenuClose.connect(function (menu) {
		        characterCreationMenu.Visible = true;
		        API.setPlayerClothes(player, 21, oldglassesIndex, oldglassesVariation);
	        });
	        ...
	        ear_menu.OnMenuClose.connect(function (menu) {
		        characterCreationMenu.Visible = true;
		        API.setPlayerClothes(player, 22, oldearIndex, oldearVariation);
	        });
            break;
    }
});
