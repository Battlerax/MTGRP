...
Event.OnServerEventTrigger.connect((eventName, args) => {
    ...
    case "create_job_zone":
            ...
            cornerStart = API.createMarker(0,
                API.getEntityPosition(player),
                new Vector3(),
                new Vector3(),
            ...
            cornerUp = API.createMarker(0,
                API.getEntityPosition(player).Add(new Vector3(xAdd, 0.0, 0.0)),
                new Vector3(),
                new Vector3(),
                new Vector3(1.0, 1.0, 1.0),
                0,
            ...
            cornerDown = API.createMarker(0,
                API.getEntityPosition(player).Add(new Vector3(0.0, yAdd, 0.0)),
                new Vector3(),
                new Vector3(),
                new Vector3(1.0, 1.0, 1.0),
                255,
