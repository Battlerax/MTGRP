...
namespace mtgvrp.job_manager.gunrunner
{
    class GunrunnerManager : Script
    {
        ...
        public static List<Vector3> DealerLocations = new List<Vector3>()
        {
            ...
            new Vector3(693.7055, -1012.08, 22.74116),
            new Vector3(1750.553, 3295.577, 41.12671),
            new Vector3(2045.062, 2949.786, 47.73578),
            new Vector3(2645.127, 2799.474, 33.9681),
            new Vector3(301.6513, 6547.77, 29.38336),
            new Vector3(-225.6476, 6245.063, 31.49273),
            new Vector3(-704.9922, 5790.983, 17.52179),
            new Vector3(502.6399, 5604.479, 797.9102),
            new Vector3(1333.155, 4327.568, 37.98491),
            new Vector3(2145.529, 4801.287, 41.11154),
            new Vector3(3332.549, 5158.603, 18.30626),
            new Vector3(3827.772, 4461.321, 2.912879),
            new Vector3(-2328.846, 292.993, 169.467),
            new Vector3(-1188.756, -542.1561, 28.74174),
            new Vector3(-848.0492, -1092.994, 9.15904),
            new Vector3(-1353.053, -1437.405, 4.323201),
            new Vector3(-217.5165, -1999.11, 27.75587),
            new Vector3(856.54, -2229.41, 30.42907),
            new Vector3(1676.406, -1634.022, 112.3591),
            new Vector3(2271.981, 1704.152, 68.10892),
            new Vector3(1538.737, 3606.745, 35.26551),
        };
