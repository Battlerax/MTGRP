...
namespace mtgvrp.core
{
    class Animations : Script
    {
        ...
        public void stopanim(Client player)
        {
            ...
            Character character = API.getEntityData(player.handle, "Character");
            character.AreHandsUp = false;
            API.getEntityData("AnimObject");
            API.detachEntity("AnimObject", true);
            API.deleteObject(player, new Vector3(0, 0, 0), -1321253704);
            API.deleteObject(player, new Vector3(0, 0, 0), 683570518);
            API.deleteObject(player, new Vector3(0, 0, 0), 175300549);
            API.deleteObject(player, new Vector3(0, 0, 0), -1425058769);
            API.deleteObject(player, new Vector3(0, 0, 0), 985101275);
            API.deleteObject(player, new Vector3(0, 0, 0), -245386275);
            API.deleteObject(player, new Vector3(0, 0, 0), -121802573);
        }
