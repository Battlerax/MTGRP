require('menu/js/menu.classes.js');



mp.events.add("playerCommand", (command) => {
    if (command == "meetme") {
        let test = mp.browsers.new('package://menu/index.html');
        
        let code = `var subSubMenuInfo = new PopupMenu('Subsub menu', null, [
